...
int main()
{
    ...
    vector <vector<int>> rec(101, vector<int>(101, 0));
    vector <vector<int>> point(n, vector<int>(4));
    ...
    for (int i = n-1; i >= 0; i--) {
        int count = 0;
        for (int k = point[i][1]; k < point[i][1] + point[i][3]; k++) {
            for (int l = point[i][0]; l < point[i][0] + point[i][2]; l++) {
                if (rec[k][l] == 0) {
                    rec[k][l] = 1;
                    count++;
                }
